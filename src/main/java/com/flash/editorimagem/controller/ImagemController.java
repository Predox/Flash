...
public class ImagemController {
    ...
    @PutMapping("/renomear/{id}")
    public ResponseEntity<?> renomearImagem(@PathVariable Long id, @RequestBody Map<String, String> payload) {
        ...
        String sql = "UPDATE imagens SET nome = ? WHERE id = ?";
